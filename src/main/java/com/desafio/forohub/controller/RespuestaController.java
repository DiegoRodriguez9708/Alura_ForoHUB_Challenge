...
@Tag(name = "Respuesta", description = "Únicamente uno puede ser la respuesta al tema.")
public class RespuestaController {
    ...
    @PostMapping
    @Transactional
    @Operation(summary = "Inserta una nueva respuesta en la base de datos, asociándola con un usuario y un tema previamente registrados.")
